  ...
  return <section className="story-section proof-footer" id="proofs" aria-labelledby="proofs-heading">
    ...
    <div className="proof-list">
      ...
      <article><h3>Earlier Swarm proof</h3><p>Owner-reported upload and retrieval on 12 September: 5,582 bytes of a mock-money statement.</p>
        ...
        <details><summary>Retrieval evidence limits</summary><p>Native encryption and deferred upload; estimated retention was 4.09 days at upload, not a guarantee of availability now. This was a different, earlier run. The separate owner-reported nova round trip is shown in OWNER RECORD when that archive is selected.</p></details>
      </article>
    </div>
